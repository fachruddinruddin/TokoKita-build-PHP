...
if (isset($_POST['confirm'])) {
	...
	if ($fetch > 0) {
		...
		$kon = mysqli_query($conn, "INSERT INTO konfirmasi (orderid, userid, payment, namarekening, bukti, tglbayar) 
	VALUES('$idorder', '$userid', '$metode', '$nama', '$bukti', '$tanggal')");
		if ($kon) {
...
<head>
	<title>Toko Kita - Konfirmasi Pembayaran</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post">
					...
					<input type="text" name="bukti" placeholder="images/" required>
					<br>
					<h6>Tanggal Bayar</h6>
